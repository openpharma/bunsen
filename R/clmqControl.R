...
clmqControl <- function(memory=1024*32,local_se=FALSE,clmq_se=FALSE,clmq_hr=TRUE,clmq_local=TRUE,
                        n_jobs=100,local_cores=1){
  structure(list(memory=memory, local_se=local_se, clmq_se=clmq_se,
